...
<html>
  ...
  <body>
    ...
    <p>Here is a list of tasks you can try: <a href="#">todo list</a>.
    ...
    on the command line. This assumes that you have git installed. See this file for a <a href="#">git howto</a>. And it is possible to inspect the <a href="http://paard.math.columbia.edu:8888/stacks.git">development history of the project</a>.
