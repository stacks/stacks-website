...
<html>
  ...
  <body>
    ...
    <p>I assume you have cloned the git repository using the command
    <pre><code>git clone git://paard.math.columbia.edu/var/git/stacks</code></pre>
    Then you will have a directory called stacks. In the rest of this howto we assume that you have changed directory into stacks.</p>
    ...
    to automatically pull new updates from the server <var>paard.math.columbia.edu</var>.</p>
