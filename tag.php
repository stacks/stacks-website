...
<?php
  ...
  function print_tag($tag) {
    ...
    if ($results['type'] == 'item') {
      ...
      print("      <li><a href='" . full_url('download/' . $results['file'] . ".pdf#nameddest=" . $tag) . "'>" . ucfirst($results['type']) . " " . $results['book_id'] . " on page " . $results['chapter_page'] . "</a> of Chapter " . $title['number'] . ": " . latex_to_html($title['title']) . "\n");
      print("      <li><a href='" . full_url('download/book.pdf#nameddest=' . $tag) . "'>" . ucfirst($results['type']) . " " . $results['book_id'] . " on page " . $results['book_page'] . "</a> of the book version\n");
    }
    elseif (substr($results['label'], -15) == 'section-phantom') {
      ...
      $title = get_title_from_filename($results['file']);
      print("      <li><a href='" . full_url('download/' . $results['file'] . ".pdf#nameddest=" . $tag) . "'>The start of the chapter</a> in  <a href='" . full_url('chapter/' . $chapter_id) . "'>Chapter " . $chapter_id . ": " . latex_to_html($chapter_information['title']) . "</a>");
      print("      <li><a href='" . full_url('download/book.pdf#nameddest=' . $tag) . "'>" . ucfirst($results['type']) . " " . $results['book_id'] . " on page " . $results['book_page'] . "</a> of the book version\n");
    }
    else {
      ...
      if ($section_id == $chapter_id or $results['type'] == 'section') {
        print("      <li><a href='" . full_url('download/' . $chapter_information['filename'] . ".pdf#nameddest=" . $tag) . "'>" . ucfirst($results['type']) . " " . $relative_id . " on page " . $results['chapter_page'] . "</a> of <a href='" . full_url('chapter/' . $chapter_id) . "'>Chapter " . $chapter_id . ": " . latex_to_html($chapter_information['title']) . "</a>\n");
      }
      else {
        $section_tag = get_tag_with_id($section_id);
        print("      <li><a href='" . full_url('download/' . $chapter_information['filename'] . ".pdf#nameddest=" . $tag) . "'>" . ucfirst($results['type']) . " " . $relative_id . " on page " . $results['chapter_page'] . "</a> of <a href='" . full_url('tag/' . $section_tag['tag']) . "'>Section " . implode('.', array_slice(explode('.', $section_id), 1)) . ": " . latex_to_html($section_information['title']) . "</a>, in <a href='" . full_url('chapter/' . $chapter_id) . "'>Chapter " . $chapter_id . ": " . latex_to_html($chapter_information['title']) . "</a>\n");
      }
