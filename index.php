...
<html>
  ...
  <body>
    ...
    <p>The entire project in one file: <a href="<?php print(full_url('download/book.pdf')); ?>">pdf version</a> | <a href="<?php print(full_url('download/book.dvi')); ?>">dvi version</a>. You can <a href="<?php print(full_url('browse')); ?>">browse the project</a>. There is a tree view which starts with <a href="<?php print(full_url('chapter/1')); ?>">Chapter 1</a>. For other downloads (e.g. TeX files) we have a <a href="<?php print(full_url('downloads')); ?>">dedicated downloads page</a>.
